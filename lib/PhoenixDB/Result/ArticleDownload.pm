use utf8;
package PhoenixDB::Result::ArticleDownload;
...
=head1 TABLE: C<article_download>

=cut

__PACKAGE__->table("article_download");
...
__PACKAGE__->set_primary_key("article_id", "download_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:XgJ6r0zTRYHq6Pcq0fBYRw
